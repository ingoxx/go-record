...
func file_streamrpc_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_streamrpc_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_streamrpc_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*StreamFileReply); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_streamrpc_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_streamrpc_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
