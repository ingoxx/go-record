...
var (
	aliWebHook = "https://oapi.dingtalk.com/robot/send?access_token=4797ec430d2b74acbfaa084960ca389d884068a0a1d6115ad10c4ac7ffabc395"
)
...
func (dd DDWarn) sendReq() error {
	...
	resp, err := http.Post(aliWebHook, "application/json", bytes.NewBuffer(b))
	if err != nil {
